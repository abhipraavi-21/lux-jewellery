...
import { NAV, PRODUCTS } from "@/lib/products";
    ...
    <section className="max-w-7xl mx-auto px-6 py-20">
      ...
      <div className="grid md:grid-cols-2 gap-8">
        {NAV.collections.map((c, i) => {
          const img = PRODUCTS[i % PRODUCTS.length].image;
          return (
            <Link key={c} to="/shop" className="group relative aspect-[16/10] overflow-hidden ring-1 ring-gold/10">
              <img src={img} alt={c} className="absolute inset-0 w-full h-full object-cover group-hover:scale-110 transition-transform duration-700" />
              ...
              <div className="absolute inset-0 p-8 flex flex-col justify-end">
                ...
                <h2 className="font-display text-3xl text-ivory mt-2">{c}</h2>
